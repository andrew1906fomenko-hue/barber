...
function AnalyticsSection({ appointments, activeServices, blockedTimes, compact = false, services, }: {
    ...
    const detailLoadPercent = detailAppointments.length + detailBlockedTimes.length ? Math.round((detailAppointments.length / (detailAppointments.length + detailBlockedTimes.length)) * 100) : 0;
    const previousDetailLoadPercent = previousDetailAppointments.length + previousDetailBlockedTimes.length ? Math.round((previousDetailAppointments.length / (previousDetailAppointments.length + previousDetailBlockedTimes.length)) * 100) : 0;
