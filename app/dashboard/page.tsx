...
function HomeSection(props: {
    ...
    unreadNotificationsCount: number;
}) { const [deleteTarget, setDeleteTarget] = useState<Appointment | null>(null); const [selectedAppointmentId, setSelectedAppointmentId] = useState<string | null>(null); const [rescheduleModalOpen, setRescheduleModalOpen] = useState(false); const [rescheduleDraft, setRescheduleDraft] = useState({ date: "", time: "" }); const [noteModalOpen, setNoteModalOpen] = useState(false); const [noteDraft, setNoteDraft] = useState(""); const [expandedCompactAppointmentId, setExpandedCompactAppointmentId] = useState<string | null>(null); const calendarSwipeStart = useRef<{
    captured: boolean;
    x: number;
    y: number;
    time: number;
